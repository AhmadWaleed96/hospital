...
class User extends Authenticatable
{
    ...
    public function scopeRay($query)
    {
        return $query->whereType('ray');
    }
    ...
    public function scopeTicketout($query)
    {
        return $query->whereType('ticketout');
    }
    public function scopeCare($query)
    {
        return $query->whereType('care');
    }
